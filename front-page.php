        ...
        <article class="contents_wrapper">
            ...
            <section id="about">
                <div class="section_wrapper">
                    <div class="section_wrapper_paragraph section_wrapper_paragraph_alignLeft">
                        <h3>ABOUT</h3>
                        <p>
                            行動力・実行力が強みです。「点と線をつなげる仕事」をモットーとして、クライアント様の形に添った制作を心がけています。
                            前職は建築の施工管理を務めていました。最近は、アニメとゲームに再燃しています。
                        </p>
                        <a class="clickHere" href="<?php echo get_page_link( 2 ); ?>">MORE</a>
                    </div>
                    <img class="section_wrapper_img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/about_banner.webp" alt="about_me">
                </div>
            ...
            <section id="works">
                <div class="section_wrapper">
                    <img class="section_wrapper_img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/works_banner.webp" alt="works">
                    <div class="section_wrapper_paragraph section_wrapper_paragraph_alignRight">           
                        <h3>WORKS</h3>
                        <p>
                            2021年からwebの技術を勉強し始め、今ではワイヤーフレーム・デザインカンプ・ページ作成と、一通りの制作が出来るようになりました。
                            シンプルで、意図がまっすぐ伝わる作品を意識しています。
                        </p>
